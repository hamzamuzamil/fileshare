  ...
  return (
    <>
      <div className="flex w-full items-center">
        <div className="flex-none mr-4 glass p-3 rounded-xl">
      ...
      <div className="mt-6 pt-4 border-t border-white/20 dark:border-white/10 w-full">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-lg font-semibold text-white dark:text-stone-200">
