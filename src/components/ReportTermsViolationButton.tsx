    ...
    <>
      <div className="flex justify-center">
        <button
          ...
          className="text-sm text-red-300 hover:text-red-200 hover:underline transition-colors duration-200"
          ...
          >
            ...
            <div className="mt-6 flex justify-end space-x-4">
              ...
              <button
                ...
                className={`px-6 py-3 bg-gradient-to-r from-red-500 to-rose-600 text-white rounded-xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed enabled:hover:from-red-600 enabled:hover:to-rose-700 enabled:hover:shadow-xl enabled:hover:scale-105 enabled:active:scale-95 transition-all duration-200 font-semibold glass-strong`}
